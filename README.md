...
See [https://codesharedot.github.io/vechain-price/](https://codesharedot.github.io/vechain-price/)
...
vechain_api_url = 'https://api.coinmarketcap.com/v1/ticker/vechain/'
response = requests.get(vechain_api_url)
